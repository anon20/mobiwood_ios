...
const ExplorVideoBottom = (props) => {
  ...
  React.useEffect(() => {
    if (props.searchVid) {
      let rslt = vidContext.videos.filter((data) =>
        data.talent.match(props.searchKeyword.toLowerCase()),
      );
    ...
    <>
      <View style={styles.suggest}>
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <TouchableOpacity
            style={[
              styles.suggestCategory,
              {backgroundColor: myTabState === 1 ? 'black' : 'grey'},
            ]}
            onPress={() => {
              setMyTabState(1);
              props.setSearchKeyword('Acting');
              let rslt = vidContext.videos.filter((data) =>
                data.talent.match(/acting/),
              );
              setVideos(rslt);
              props.setSearchVid(false);
            }}>
          ...
          <TouchableOpacity
            style={[
              styles.suggestCategory,
              {backgroundColor: myTabState === 2 ? 'black' : 'grey'},
            ]}
            onPress={() => {
              setMyTabState(2);
              props.setSearchKeyword('Singing');
              let rslt = vidContext.videos.filter((data) =>
                data.talent.match(/singing/),
              );
              setVideos(rslt);
              props.setSearchVid(false);
            }}>
          ...
          <TouchableOpacity
            style={[
              styles.suggestCategory,
              {backgroundColor: myTabState === 3 ? 'black' : 'grey'},
            ]}
            onPress={() => {
              setMyTabState(3);
              props.setSearchKeyword('Dancing');
              let rslt = vidContext.videos.filter((data) =>
                data.talent.match(/dancing/),
              );
              setVideos(rslt);
              props.setSearchVid(false);
            }}>
          ...
          <TouchableOpacity
            style={[
              styles.suggestCategory,
              {backgroundColor: myTabState === 5 ? 'black' : 'grey'},
            ]}
            onPress={() => {
              setMyTabState(5);
              props.setSearchKeyword('Comedy');
              let rslt = vidContext.videos.filter((data) =>
                data.talent.match(/comedy/),
              );
              setVideos(rslt);
              props.setSearchVid(false);
            }}>
          ...
          <TouchableOpacity
            style={[
              styles.suggestCategory,
              {backgroundColor: myTabState === 6 ? 'black' : 'grey'},
            ]}
            onPress={() => {
              setMyTabState(6);
              props.setSearchKeyword('Music');
              let rslt = vidContext.videos.filter((data) =>
                data.talent.match(/music/),
              );
              setVideos(rslt);
              props.setSearchVid(false);
            }}>
          ...
          <TouchableOpacity
            style={[
              styles.suggestCategory,
              {backgroundColor: myTabState === 7 ? 'black' : 'grey'},
            ]}
            onPress={() => {
              setMyTabState(7);
              props.setSearchKeyword('Magic');
              let rslt = vidContext.videos.filter((data) =>
                data.talent.match(/magic/),
              );
              setVideos(rslt);
              props.setSearchVid(false);
            }}>
          ...
          <TouchableOpacity
            style={[
              styles.suggestCategory,
              {backgroundColor: myTabState === 8 ? 'black' : 'grey'},
            ]}
            onPress={() => {
              setMyTabState(8);
              props.setSearchKeyword('Aerobatics');
              let rslt = vidContext.videos.filter((data) =>
                data.talent.match(/aerobatics/),
              );
              setVideos(rslt);
              props.setSearchVid(false);
            }}>
